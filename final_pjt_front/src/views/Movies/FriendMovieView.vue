<template>
  <div class="freind-movie">
    <h2 class="movieKeyword my-5">친구와의 시간<span class="light-font">을 가지고 싶다면,</span></h2>
    <div class="genre-lst row">
      <div class="col-sm-6 col-lg-3">액션</div>
      <div class="col-sm-6 col-lg-3">범죄</div>
      <div class="col-sm-6 col-lg-3">스릴러</div>
      <div class="col-sm-6 col-lg-3">SF</div>
    </div>
    <div class="row mt-5">
      <ChooseMovieItem
